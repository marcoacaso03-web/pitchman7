      ...
      <Sheet open={showIOSSheet} onOpenChange={(open) => !open && dismissIOSSheet()}>
        ...
        >
          ...
          <Button
            ...
            className="w-full h-12 rounded-2xl font-black uppercase text-sm bg-primary dark:bg-black border border-primary dark:border-brand-orange text-white dark:text-brand-orange hover:opacity-90 dark:hover:bg-brand-orange/10 shadow-lg dark:shadow-[0_0_15px_rgba(172,229,4,0.2)] transition-all"
          >
            Ho capito
          </Button>
        </SheetContent>
